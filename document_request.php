...
<html lang="en">
			...
			<div class="content-wrapper">
				<div class="content-header">
					<div class="container-fluid">
						<div class="row mb-2">
							<div class="col-sm-6">
								<h1 class="m-0">Document Request</h1>
							</div><!-- /.col -->
							<div class="col-sm-6">
				...
				<section class="content">
					<div class="container-fluid">
						<div class = "row">
							<div class = "col-3"><?php
								$documentsRequestForm = root_url("pages/includes/documents_request/documents_request_form.php");
								include($documentsRequestForm);
							?></div>
							<div class = "col-9"><?php
								$documentsRequestCondition = "u.users_id = '".ID."' ";
								$documentsRequestList = $select->get_active_documents_request_list("", $documentsRequestCondition);
								$documentsRequestListView = root_url("pages/includes/documents_request/documents_request_list.php");
								include($documentsRequestListView);
							?></div>
						</div>
					</div>
				</section>
	...
	<?php
		...
		include($pageJs);
	?>
		<script src="<?php echo $js ?>/pages/display/documents_request.js"></script>
	</body>
</html>
