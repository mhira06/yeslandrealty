<?php
	...
	$page = "manage_documents_request";
	$title = "Manage Documents Request";
	$action = $function->get("action");
?>
<!DOCTYPE html>
<html lang="en">
	...
	<?php
		...
		include($pageJs);
	?>
		<script src="<?php echo $js ?>/pages/administration/manage_documents_request.js"></script>
	</body>
</html>
